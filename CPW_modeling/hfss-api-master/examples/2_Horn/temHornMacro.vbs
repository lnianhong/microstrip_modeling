...
oEditor.CreatePolyline _
	Array("NAME:PolylineParameters", "IsPolylineCovered:=", true, "IsPolylineClosed:=", Spline, _
...
oProject.SaveAs _
    "E:\研究生期间2015-2018\研究生课程学习\微带线建模\hfss-api-master\examples\2_Horn\temHornEPlaneArraySnow.hfss", _
    true
