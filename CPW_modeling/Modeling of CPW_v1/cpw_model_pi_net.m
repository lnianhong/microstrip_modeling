function [ s_param_model] = cpw_model_pi_net(freq,L_0123_fit,R_0123_fit,...,
                                             G_123_fit,C_0123_fit,...,
                                             f_RL,f_GC,...,
                                             cpw_len,num_pi)
...
G_model_len =             G_123_len(1)* (1-1./(1+(freq./f_GC(1)).^2)) + ...,
    G_123_len(2)* (1-1./(1+(freq./f_GC(2)).^2)) + ...,
    G_123_len(3)* (1-1./(1+(freq./f_GC(3)).^2));
