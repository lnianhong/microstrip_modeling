...
R_sim = zeros(200,files_num);
L_sim = zeros(200,files_num);
G_sim = zeros(200,files_num);
C_sim = zeros(200,files_num);
alpha_sim = zeros(200,files_num);
beta_sim = zeros(200,files_num);
...
legend('L=150','L=200','L=233','L=250','L=300','L=350','L=400');
grid on
grid minor
