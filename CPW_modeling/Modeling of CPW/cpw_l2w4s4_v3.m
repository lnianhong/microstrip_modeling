...
for ii = 1:length(f_2_zone)
    ...
    num_RL_net = 3;
    [L_0123,R_0123,~,~ ] = cpw_model( f_123,freq,R,L,G,C,num_RL_net);
...
for ii = 1:length(f_2_zone)
    ...
    num_RL_net = 3;
    [~,~,G_123,C_0123 ] = cpw_model( f_123,freq,R,L,G,C,num_RL_net);
    % L_0123,R_0123,G_123,C_0123 are the prameters of each section!
...
[ s_param_model] = cpw_model_pi_net(freq,L_0123_fit,R_0123_fit,G_123_fit,C_0123_fit,f_123_RL_fit,f_123_GC_fit,len,num_pi);
