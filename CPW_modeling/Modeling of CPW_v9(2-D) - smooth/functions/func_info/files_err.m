...
for k =1:num_files
    ...
    cpwmodel.files_info(k).err_model.max_err_Z_real = max(cpwmodel.files_info(k).err_model.err_Z_real);
    cpwmodel.files_info(k).err_model.ave_err_Z_real = mean(cpwmodel.files_info(k).err_model.err_Z_real);
    ...
    cpwmodel.files_info(k).err_model.max_err_Z_imag = max(cpwmodel.files_info(k).err_model.err_Z_imag);
    cpwmodel.files_info(k).err_model.ave_err_Z_imag = mean(cpwmodel.files_info(k).err_model.err_Z_imag);
    ...
    cpwmodel.files_info(k).err_model.err_RLGC(1:10,3) = cpwmodel.files_info(k).err_model.err_RLGC(11,3);
    % the value of G under low frequency nears zero 
