...
l2w4s4_file = './S_parameters_sim/S400_ideal_500G.csv';
% l2w4s4_file = './S_parameters_sim/GL400.csv';
...
%% extract the RLGC
len =400e-6;% the unit is different with doctor Fu£¬doctor Fu use cm as the unit of the length
