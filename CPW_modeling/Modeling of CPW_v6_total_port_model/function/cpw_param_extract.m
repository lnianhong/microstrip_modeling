function [R_0123,L_0123,G_0123,C_0123 ] = cpw_param_extract( f_123,freq,R,L,G,C,flag,num_RL_net)
...
L_0123 = zeros(1,num_RL_net+1);
R_0123 = zeros(1,num_RL_net+1);
if strcmp(flag,'RL') || strcmp(flag,'RLGC')
...
%% Shunt Model
G_0123 = zeros(1,num_RL_net+1);
C_0123 = zeros(1,num_RL_net+1);
