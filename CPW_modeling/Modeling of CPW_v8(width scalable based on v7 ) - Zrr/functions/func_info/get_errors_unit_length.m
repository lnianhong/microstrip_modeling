...
err_struct.max_Z_real = [cpwmodel.max_Z_real];
err_struct.ave_Z_real = [cpwmodel.ave_Z_real];

err_struct.max_Z_imag = [cpwmodel.max_Z_imag];
err_struct.ave_Z_imag = [cpwmodel.ave_Z_imag];
