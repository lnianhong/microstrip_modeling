...
cpwmodel_single.max_err_Z_real = max(cpwmodel_single.err_Z_real);
cpwmodel_single.ave_err_Z_real = mean(cpwmodel_single.err_Z_real);
cpwmodel_single.err_Z_imag = eval_model(imag(cpwmodel_single.Z_sim),imag(cpwmodel_single.Z_fit),'abs');
cpwmodel_single.max_err_Z_imag = max(cpwmodel_single.err_Z_imag);
cpwmodel_single.ave_err_Z_imag = mean(cpwmodel_single.err_Z_imag);
