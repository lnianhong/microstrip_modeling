...
% Width_array = [4.5 6.5 7.5];
% Space_array = [4];
Width_array = [4 5 6 7 8 9 10];
Space_array = [3 4 5 6 7 8 9 10];
len_pi = 12.5*1e-6;
...
%             files_info(k).name=sprintf('./S_parameters_sim/fortest/L%dW%sS%d.csv',len(k),num2str(width),space);
...
recycle('on')
save_name = 'tmp_data/cpw_2D_W4-10_S3_10.mat';
...
% recycle('on')
% save_name = 'tmp_data/cpw4test.mat';
% if exist(save_name,'file')
%     delete(save_name);
% end
% cpw4test = cpw_cell;
% save(save_name,'cpw4test');