function [ coef_2D] = fit_RLGC0123_2D_bak( Width_array,Space_array,RLGC_0123_mat,first_var)
...
W_interp = min(Width_array):1:max(Width_array);
S_interp = min(Space_array):2:max(Space_array);
