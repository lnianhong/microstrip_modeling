...
% l2w4s4_file = './S_parameters_sim/1mm1cm.csv';
l2w4s4_file = '../S_parameters_sim/L600_S.csv';
% l2w4s4_file = './S_parameters_sim/8-10G.csv';
...
S11_db = 20 *log10(abs(reshape(s_params(1,1,:),[],1)));
S11_real = real(reshape(s_params(1,1,:),[],1));
S11_imag = imag(reshape(s_params(1,1,:),[],1));
...
figure
plot(freq,S11_real,freq,S11_imag)
title('Mag S11');
