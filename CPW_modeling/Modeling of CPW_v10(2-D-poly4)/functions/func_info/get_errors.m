...
max_err_Z_real = zeros(m,n);
ave_err_Z_real = zeros(m,n);
max_err_Z_imag = zeros(m,n);
ave_err_Z_imag = zeros(m,n);
...
for ii =1:m
    for jj=1:n
        ...
        max_err_Z_real(ii,jj) = err_model.max_err_Z_real;
        ave_err_Z_real(ii,jj) = err_model.ave_err_Z_real;
        max_err_Z_imag(ii,jj) = err_model.max_err_Z_imag;
        ave_err_Z_imag(ii,jj) = err_model.ave_err_Z_imag;
    end
end
...
err_struct.max_err_Z_real = max_err_Z_real;
err_struct.ave_err_Z_real = ave_err_Z_real;

err_struct.max_err_Z_imag = max_err_Z_imag;
err_struct.ave_err_Z_imag = ave_err_Z_imag;
