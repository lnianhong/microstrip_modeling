function [ s_param_model] = cpw_model_pi_net(freq,RLGC_0123_fit,cpw_len,num_pi)
...
R_0123_len = R_0123_fit*cpw_len ;% H
L_0123_len = L_0123_fit*cpw_len;% omega
...
for k =1:length(freq)
    ...
    ABCD_Z = [1, Z_model_len(k)./(2*num_pi);0,1];
    ABCD_param_model(:,:,k) = ABCD_Y_left_right *ABCD_Z* ...,
                        ((ABCD_Z*ABCD_Y_medium*ABCD_Z)^(num_pi-1))* ...,
