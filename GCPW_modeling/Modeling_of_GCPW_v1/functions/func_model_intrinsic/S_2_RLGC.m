function [RLGC,gamma,Z] = S_2_RLGC(s_params,freq,len,z0)
...
[ beta_len_correct,jump_index ] = linkjump( beta_len,5,2*pi);

gamma = alpha + (beta_len_correct./len)*1i;
